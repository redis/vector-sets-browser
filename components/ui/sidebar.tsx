...
>(({ className, children, side = "left", defaultWidth = 384, minWidth = 256, maxWidth = 800, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex-none bg-sidebar border-r h-screen flex flex-col",
        className
      )}
      style={{ width }}
      {...props}
    >
      ...
      <div
        className={cn(
          "absolute top-0 bottom-0 w-1 cursor-col-resize hover:bg-sidebar-accent/50",
