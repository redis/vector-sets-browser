...
interface ControlPanelProps {
    ...
    onTogglePin: () => void
    onExpandNode: (node: THREE.Mesh, skipLayoutReapplication?: boolean) => void | Promise<void>
                                ...
                                <div className="grid gap-2">
                                    ...
                                    {selectedNode.userData.similarity !== null && (
                                        <div className="">
                                            ...
                                            <span className="pl-1">
                                                {selectedNode.userData.similarity?.toFixed(4)}
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    <div className="flex gap-2 mt-2 w-full">
                                        ...
                                        {selectedNode.userData.expanded &&
                                            selectedNode.userData.displayState === "expanded" && (
                                                <Button
                                                    onClick={() => onCollapseNode(selectedNode)}
                                                    className="w-full"
                                                    variant="outline"
                                                >
                                                    Hide Neighbors
                                        ...
                                        {selectedNode.userData.expanded &&
                                            selectedNode.userData.displayState === "collapsed" && (
                                                <Button
                                                    onClick={() => onExpandNode(selectedNode)}
                                                    className="w-full"
                                                    variant="outline"
            ...
            <AlertDialog open={isResetDialogOpen} onOpenChange={setIsResetDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            This will remove all nodes except the initial one and restart
                            the visualization. Are you sure you want to continue?
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
