            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription className="text-red-500 font-medium">
                        This action will permanently delete the vector set &quot;{vectorSetName}&quot; and all its data.
                        This action cannot be undone.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="py-4">
                    <Label htmlFor="confirm-text" className="text-sm font-medium">
                        To confirm, type the name of the vector set: <span className="font-bold">{vectorSetName}</span>
                    </Label>
                    <Input
                        id="confirm-text"
                        value={confirmText}
