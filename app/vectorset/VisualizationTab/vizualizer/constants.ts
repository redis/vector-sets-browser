export const COLORS_REDIS_LIGHT = {
    NODE: {
        DEFAULT: 0x000000, // Default blue color for nodes
    ...
    EDGE: {
        DEFAULT: 0xff0000, // Default blue color for edges
    },
...
export const NODE_SIZE = {
    DEFAULT: 0.7,       // Regular node size
    HIGHLIGHT: 0.7  ,     // Size for highlighted/hovered nodes
} as const 