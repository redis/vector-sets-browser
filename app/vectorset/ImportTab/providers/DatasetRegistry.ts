import { BookOpen, Film, User } from "lucide-react"
...
const BookIcon = () => <BookOpen className="h-5 w-5 text-blue-500" />
const MovieIcon = () => <Film className="h-5 w-5 text-amber-500" />
const FaceIcon = () => <User className="h-5 w-5 text-violet-500" />
...
const textDatasetProvider = new TextDatasetProvider([
    {
        ...
        icon: BookIcon as unknown as ReactNode,
    ...
    },
    {
        ...
        icon: MovieIcon as unknown as ReactNode,
...
const imageDatasetProvider = new ImageDatasetProvider([
    {
        ...
        icon: FaceIcon as unknown as ReactNode,
